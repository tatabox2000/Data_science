	...
	i = 1
		...
		if area > self.maxArea:
			...
			all_cnt.append(cnt)
                	...
                	pass
    	return mask,all_,mask_area,all_num,all_cnt
	...
	with codecs.open(self.filename,'ab','cp932') as pic:
		all_color = []
    		...
    		for name in glob.glob('*\*.jpg'):
				...
				imgray_mask,all_1,mask_area1,self.all_num1,self.all_cnt1 = self.picture_mask(imgray)
				UV_mask,all_2,mask_area2,self.all_num1,self.all_cnt1 = self.picture_mask(th_UV)
