...
#
# Created: Fri Nov 21 20:36:16 2014
...
class Ui_Qt_CV_MainWindow(object):
    def setupUi(self, Qt_CV_MainWindow):
        ...
        Qt_CV_MainWindow.resize(1085, 827)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(410, 50, 421, 41))
        ...
        self.pic_view.setGeometry(QtCore.QRect(519, 210, 551, 561))
        ...
        self.exec_button.setGeometry(QtCore.QRect(660, 10, 81, 31))
        ...
        self.file_scrollbar.setGeometry(QtCore.QRect(400, 190, 431, 20))
        ...
        self.hist_view.setGeometry(QtCore.QRect(397, 210, 121, 561))
        ...
        self.Mode_combo.setGeometry(QtCore.QRect(110, 40, 271, 22))
        self.Mode_combo.setObjectName("Mode_combo")
        self.Mode_combo.addItem("")
        self.Mode_combo.addItem("")
        self.label_11 = QtGui.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(20, 44, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.size_edit.setGeometry(QtCore.QRect(410, 11, 51, 31))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_13.setGeometry(QtCore.QRect(480, 0, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_13.setFont(font)
        self.label_13.setObjectName("label_13")
        self.sub_view = GraphicsLayoutWidget(self.centralwidget)
        self.sub_view.setGeometry(QtCore.QRect(840, 0, 231, 201))
        self.sub_view.setObjectName("sub_view")
        self.EBA_button = QtGui.QPushButton(self.centralwidget)
        self.EBA_button.setGeometry(QtCore.QRect(750, 10, 81, 31))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_17.setGeometry(QtCore.QRect(480, 30, 101, 20))
        self.label_17.setObjectName("label_17")
        self.tableWidget = QtGui.QTableWidget(self.centralwidget)
        self.tableWidget.setGeometry(QtCore.QRect(400, 100, 431, 81))
        ...
        self.label_18.setGeometry(QtCore.QRect(20, 74, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_18.setFont(font)
        self.label_18.setObjectName("label_18")
        self.save_mode_combo = QtGui.QComboBox(self.centralwidget)
        self.save_mode_combo.setGeometry(QtCore.QRect(110, 70, 271, 22))
    ...
    def retranslateUi(self, Qt_CV_MainWindow):
        ...
        self.label_13.setText(QtGui.QApplication.translate("Qt_CV_MainWindow", "μ㎡/pix　", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_17.setText(QtGui.QApplication.translate("Qt_CV_MainWindow", "[Enter this number]", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.tableWidget.horizontalHeaderItem(1).setText(QtGui.QApplication.translate("Qt_CV_MainWindow", "area size", None, QtGui.QApplication.UnicodeUTF8))
        self.tableWidget.horizontalHeaderItem(2).setText(QtGui.QApplication.translate("Qt_CV_MainWindow", "count", None, QtGui.QApplication.UnicodeUTF8))
        self.tableWidget.horizontalHeaderItem(3).setText(QtGui.QApplication.translate("Qt_CV_MainWindow", "average", None, QtGui.QApplication.UnicodeUTF8))
        self.tableWidget.horizontalHeaderItem(4).setText(QtGui.QApplication.translate("Qt_CV_MainWindow", "median", None, QtGui.QApplication.UnicodeUTF8))
