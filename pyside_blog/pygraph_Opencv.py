...
#
# Created: Wed Feb 25 12:02:52 2015
...
class Ui_Qt_CV_MainWindow(object):
    def setupUi(self, Qt_CV_MainWindow):
        ...
        Qt_CV_MainWindow.resize(1082, 813)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(410, 50, 661, 41))
        ...
        self.label_13.setGeometry(QtCore.QRect(480, 0, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_13.setFont(font)
        self.label_13.setObjectName("label_13")
        self.sub_view = GraphicsLayoutWidget(self.centralwidget)
        self.sub_view.setGeometry(QtCore.QRect(165, 570, 231, 201))
        ...
        self.label_17.setGeometry(QtCore.QRect(470, 30, 111, 20))
        self.label_17.setObjectName("label_17")
        self.tableWidget = QtGui.QTableWidget(self.centralwidget)
        self.tableWidget.setGeometry(QtCore.QRect(400, 100, 671, 81))
        ...
        self.label_18.setGeometry(QtCore.QRect(20, 54, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_18.setFont(font)
        self.label_18.setObjectName("label_18")
        self.save_mode_combo = QtGui.QComboBox(self.centralwidget)
        self.save_mode_combo.setGeometry(QtCore.QRect(110, 50, 171, 22))
        ...
        self.form_view_or_image_2.setGeometry(QtCore.QRect(20, 700, 141, 20))
        self.form_view_or_image_2.setObjectName("form_view_or_image_2")
        self.save_pic_check = QtGui.QCheckBox(self.centralwidget)
        self.save_pic_check.setGeometry(QtCore.QRect(290, 52, 91, 16))
        self.save_pic_check.setObjectName("save_pic_check")
        Qt_CV_MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtGui.QMenuBar(Qt_CV_MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1082, 24))
    ...
    def retranslateUi(self, Qt_CV_MainWindow):
        ...
        self.label_17.setText(QtGui.QApplication.translate("Qt_CV_MainWindow", "[ a side ; pixcel ]", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.save_pic_check.setText(QtGui.QApplication.translate("Qt_CV_MainWindow", "save picture", None, QtGui.QApplication.UnicodeUTF8))
