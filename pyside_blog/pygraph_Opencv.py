...
#
# Created: Tue Oct 14 21:45:41 2014
...
class Ui_Qt_CV_MainWindow(object):
    def setupUi(self, Qt_CV_MainWindow):
        ...
        Qt_CV_MainWindow.resize(1044, 720)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(400, 60, 371, 41))
        ...
        self.pic_view.setGeometry(QtCore.QRect(520, 150, 512, 512))
        ...
        self.exec_button.setGeometry(QtCore.QRect(690, 3, 81, 51))
        ...
        self.file_scrollbar.setGeometry(QtCore.QRect(400, 110, 371, 31))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(20, 290, 120, 101))
        ...
        self.hist_view.setGeometry(QtCore.QRect(400, 150, 111, 511))
        ...
        self.smooth_combo.setGeometry(QtCore.QRect(110, 212, 271, 22))
        self.smooth_combo.setObjectName("smooth_combo")
        self.smooth_combo.addItem("")
        self.smooth_combo.addItem("")
        self.smooth_combo.addItem("")
        self.line_2 = QtGui.QFrame(self.centralwidget)
        self.line_2.setGeometry(QtCore.QRect(0, 400, 391, 16))
        self.line_2.setFrameShape(QtGui.QFrame.HLine)
        self.line_2.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.label_7 = QtGui.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(10, 410, 321, 46))
        font = QtGui.QFont()
        ...
        self.label_8.setGeometry(QtCore.QRect(10, 250, 131, 46))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setWeight(75)
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(20, 450, 121, 101))
        ...
        self.threshold1_edit.setGeometry(QtCore.QRect(140, 300, 61, 31))
        ...
        self.threshold2_edit.setGeometry(QtCore.QRect(140, 354, 61, 31))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.threshold1_slider.setGeometry(QtCore.QRect(210, 305, 179, 19))
        ...
        self.threshold2_slider.setGeometry(QtCore.QRect(210, 360, 179, 19))
        ...
        self.min_area_edit.setGeometry(QtCore.QRect(140, 515, 59, 31))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.max_area_edit.setGeometry(QtCore.QRect(140, 460, 61, 31))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.max_area_slider.setGeometry(QtCore.QRect(210, 465, 179, 19))
        ...
        self.min_area_slider.setGeometry(QtCore.QRect(210, 520, 179, 19))
        ...
        self.form_view_or_image.setGeometry(QtCore.QRect(210, 620, 181, 19))
        self.form_view_or_image.setObjectName("form_view_or_image")
        self.threshold1_edit_2 = QtGui.QLineEdit(self.centralwidget)
        self.threshold1_edit_2.setGeometry(QtCore.QRect(400, 11, 71, 31))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_13.setGeometry(QtCore.QRect(480, 6, 211, 46))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_13.setFont(font)
        self.label_13.setObjectName("label_13")
        self.sub_view = GraphicsLayoutWidget(self.centralwidget)
        self.sub_view.setGeometry(QtCore.QRect(790, 0, 241, 141))
    ...
    def retranslateUi(self, Qt_CV_MainWindow):
        ...
        self.smooth_combo.setItemText(1, QtGui.QApplication.translate("Qt_CV_MainWindow", "Blateral Filter", None, QtGui.QApplication.UnicodeUTF8))
        self.smooth_combo.setItemText(2, QtGui.QApplication.translate("Qt_CV_MainWindow", "Gaussian Filter", None, QtGui.QApplication.UnicodeUTF8))
