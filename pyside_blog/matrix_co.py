...
class coordinateForCv:
	...
	def coordinate2cv(self,x=None,y=None):
		temp_coor =  np.zeros((self.pyqt_pic.shape[0],self.pyqt_pic.shape[1]),np.uint8)
		index = zip(x,y)
		for i,j in index:
			#print j,i
...
if __name__ == '__main__':
	...
	before,after,calc = a.coordinate2cv(x,y)
